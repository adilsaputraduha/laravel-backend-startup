                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-centered dt-responsive table-nowrap mb-0" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($store as $number => $data)
                                <tr>
                                    <td>{{ ++$number }}</td>
                                    <td>{{ $data->storeName }}</td>
                                    <td>{{ $data->storeEmail }}</td>
                                    <td>{{ $data->storeCity }}, {{ $data->storeProvince }}</td>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-green btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#editModal{{ $data->storeId }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="off" name="name" placeholder="Type new name ..." required />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" autocomplete="off" name="email" placeholder="Type new email ..." required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="off" name="phonenumber" placeholder="Type new phone number ..." required />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label class="form-label">Zip Code</label>
                                <input type="text" class="form-control" autocomplete="off" name="zipcode" placeholder="Type new zip code ..." required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Type new street ..." name="street" style="height: 100px"></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="off" name="district" placeholder="Type new district ..." required />
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3">
                                <label class="form-label">City</label>
                                <input type="text" class="form-control" autocomplete="off" name="city" placeholder="Type new city ..." required />
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3">
                                <label class="form-label">Province</label>
                                <input type="text" class="form-control" autocomplete="off" name="province" placeholder="Type new province ..." required />
                            </div>
                        </div>
                    </div>
                </div>
